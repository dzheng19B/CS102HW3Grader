...
> Generated 2026-05-20 02:31  
> 79 graded, 29 all-pass, 8 minor errors, 42 critical errors, 0 compile errors after repair
...
|--:|---------|---------|------:|----------|---------|--------|--------------|
| 1 | Attina, Ava | Evaluate Reverse Polish Notation | 0/7 | Critical Error | Yes | aggressive | example1, example2, example3, add_only, single, subtract, neg_divide |
| 2 | Balkam, Tianna | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | lightweight | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
| 3 | Batz, Alison | Merge Two Sorted Lists | 0/7 | Critical Error | Yes | aggressive | example1, both_empty, one_empty, other_empty, interleave, all_same, single_each |
| 4 | Broderick, Maddie | Contains Nearby Duplicate | 0/8 | Critical Error | Yes | lightweight | true_basic, true_adjacent, false_too_far, false_k_zero, single_element, no_dups, true_exact_k, empty |
| 5 | Calandra, Clare | Longest Substring Without Repeating Characters | 8/8 | PASS | Yes | lightweight |  |
| 6 | Calin, Stephania | Merge Two Sorted Lists | 7/7 | PASS | Yes | lightweight |  |
| 7 | Carey, Carson | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | aggressive | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
| 8 | Carhart, Sean | Evaluate Reverse Polish Notation | 0/7 | Critical Error | Yes | aggressive | example1, example2, example3, add_only, single, subtract, neg_divide |
| 9 | Carozza, Ashley | Evaluate Reverse Polish Notation | 7/7 | PASS | Yes | lightweight |  |
| 10 | Chan, Cheong Ting Eland | Contains Nearby Duplicate | 6/8 | Minor Error | Yes | lightweight | true_basic, true_exact_k |
| 11 | Chan, Gaven | Guess Number Higher or Lower | 0/7 | Critical Error | Yes | lightweight | basic, single, pick_low, pick_high, large, mid_range, pick_is_n |
| 12 | Chen, Albert | Guess Number Higher or Lower | 7/7 | PASS | Yes | lightweight |  |
| 13 | Chen, Shunyi | Longest Substring Without Repeating Characters | 6/8 | Minor Error | Yes | lightweight | example3, spaces |
| 14 | Cheung, Ivan | Evaluate Reverse Polish Notation | 7/7 | PASS | Yes | lightweight |  |
| 15 | Connors, William | Guess Number Higher or Lower | 0/7 | Critical Error | Yes | aggressive | basic, single, pick_low, pick_high, large, mid_range, pick_is_n |
| 16 | Conroy, William | Longest Substring Without Repeating Characters | 8/8 | PASS | Yes | lightweight |  |
| 17 | Coverdale, Solomon | Contains Nearby Duplicate | 8/8 | PASS | Yes | lightweight |  |
| 18 | DiNapoli, Michael | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | lightweight | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
| 19 | Diusheyeva, Lilia | Guess Number Higher or Lower | 7/7 | PASS | Yes | lightweight |  |
| 20 | Friedlander, Nicholas | Longest Substring Without Repeating Characters | 8/8 | PASS | Yes | lightweight |  |
| 21 | Gaston, Justin | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | aggressive | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
| 22 | Genc, Sude | Contains Nearby Duplicate | 8/8 | PASS | Yes | lightweight |  |
| 23 | Gnajewski, Monica | Merge Two Sorted Lists | 0/7 | Critical Error | Yes | aggressive | example1, both_empty, one_empty, other_empty, interleave, all_same, single_each |
| 24 | Godzki, Kyle | Evaluate Reverse Polish Notation | 3/7 | Critical Error | Yes | lightweight | example2, example3, subtract, neg_divide |
| 25 | Guo, Jason | Contains Nearby Duplicate | 1/8 | Critical Error | Yes | lightweight | true_basic, true_adjacent, false_too_far, false_k_zero, single_element, no_dups, true_exact_k |
| 26 | Halsband, Samuel | Longest Substring Without Repeating Characters | 8/8 | PASS | Yes | lightweight |  |
| 27 | Juance, Reginald | Guess Number Higher or Lower | 0/7 | Critical Error | Yes | aggressive | basic, single, pick_low, pick_high, large, mid_range, pick_is_n |
| 28 | Karamchandani, Varun | Merge Two Sorted Lists | 0/7 | Critical Error | Yes | lightweight | example1, both_empty, one_empty, other_empty, interleave, all_same, single_each |
| 29 | Kukreti, Naman | Guess Number Higher or Lower | 7/7 | PASS | Yes | lightweight |  |
| 30 | Lee, Kristen | Guess Number Higher or Lower | 2/7 | Critical Error | Yes | java-transpile | basic, single, pick_high, large, pick_is_n |
| 31 | Lin, Brian | Contains Nearby Duplicate | 5/8 | Minor Error | Yes | aggressive | true_basic, true_adjacent, true_exact_k |
| 32 | Lin, Tiffany | Contains Nearby Duplicate | 4/8 | Critical Error | Yes | lightweight | true_basic, true_adjacent, true_exact_k, empty |
| 33 | Lu, Zhi Xiong | Merge Two Sorted Lists | 7/7 | PASS | Yes | lightweight |  |
| 34 | Mahaman Sani, Abdoul Razakou | Evaluate Reverse Polish Notation | 5/7 | Minor Error | Yes | lightweight | example3, single |
| 35 | Majlis, Mahir | Evaluate Reverse Polish Notation | 0/7 | Critical Error | Yes | aggressive | example1, example2, example3, add_only, single, subtract, neg_divide |
| 36 | Maldonado, Noel | Longest Substring Without Repeating Characters | 8/8 | PASS | Yes | lightweight |  |
| 37 | McBean, Andrew | Contains Nearby Duplicate | 1/8 | Critical Error | Yes | lightweight | true_basic, true_adjacent, false_too_far, false_k_zero, single_element, no_dups, true_exact_k |
| 38 | Minhas, Vikram | Merge Two Sorted Lists | 1/7 | Critical Error | Yes | lightweight | example1, both_empty, other_empty, interleave, all_same, single_each |
| 39 | Moran, Juan | Evaluate Reverse Polish Notation | 0/7 | Critical Error | Yes | lightweight | example1, example2, example3, add_only, single, subtract, neg_divide |
| 40 | Ng, Gavin | Evaluate Reverse Polish Notation | 7/7 | PASS | Yes | lightweight |  |
| 41 | Ng, Kenneth | Merge Two Sorted Lists | 0/7 | Critical Error | Yes | aggressive | example1, both_empty, one_empty, other_empty, interleave, all_same, single_each |
| 42 | Noh, Jin | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | aggressive | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
| 43 | Park, Matthew | Guess Number Higher or Lower | 7/7 | PASS | Yes | lightweight |  |
| 44 | Patel, Ved | Evaluate Reverse Polish Notation | 0/7 | Critical Error | Yes | aggressive | example1, example2, example3, add_only, single, subtract, neg_divide |
| 45 | Porto, Ian | Merge Two Sorted Lists | 1/7 | Critical Error | Yes | lightweight | example1, both_empty, one_empty, interleave, all_same, single_each |
| 46 | Ramos Rodriguez, Jordanny | Guess Number Higher or Lower | 0/7 | Critical Error | Yes | aggressive | basic, single, pick_low, pick_high, large, mid_range, pick_is_n |
| 47 | Regueiferos, Logan | Evaluate Reverse Polish Notation | 6/7 | Minor Error | Yes | lightweight | example3 |
| 48 | Rpk, Parks | Guess Number Higher or Lower | 7/7 | PASS | Yes | lightweight |  |
| 49 | Safronov, Danila | Contains Nearby Duplicate | 8/8 | PASS | Yes | lightweight |  |
| 50 | Santhosh, Athulya | Merge Two Sorted Lists | 3/7 | Critical Error | Yes | lightweight | example1, interleave, all_same, single_each |
| 51 | Schauber, Kathryn | Merge Two Sorted Lists | 3/7 | Critical Error | Yes | lightweight | example1, interleave, all_same, single_each |
| 52 | Sellam, Naomi | Evaluate Reverse Polish Notation | 7/7 | PASS | Yes | lightweight |  |
| 53 | Seng, Jason | Evaluate Reverse Polish Notation | 1/7 | Critical Error | Yes | lightweight | example1, example2, example3, add_only, subtract, neg_divide |
| 54 | Singh, Kushagra | Evaluate Reverse Polish Notation | 7/7 | PASS | Yes | lightweight |  |
| 55 | Steck, Jake | Longest Substring Without Repeating Characters | 8/8 | PASS | Yes | lightweight |  |
| 56 | Stehura, Max | Evaluate Reverse Polish Notation | 0/7 | Critical Error | Yes | lightweight | example1, example2, example3, add_only, single, subtract, neg_divide |
| 57 | Stevens, Jack | Contains Nearby Duplicate | 6/8 | Minor Error | Yes | lightweight | false_too_far, false_k_zero |
| 58 | Thelusma, Treyson | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | lightweight | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
| 59 | Tsui, Ryan | Merge Two Sorted Lists | 7/7 | PASS | Yes | lightweight |  |
| 60 | Vallarta, Giankyle | Evaluate Reverse Polish Notation | 0/7 | Critical Error | Yes | aggressive | example1, example2, example3, add_only, single, subtract, neg_divide |
| 61 | Vega, Dominic | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | aggressive | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
| 62 | Wahlin, Kartik | Evaluate Reverse Polish Notation | 3/7 | Critical Error | Yes | lightweight | example2, example3, subtract, neg_divide |
| 63 | Wang, Hewitt | Guess Number Higher or Lower | 7/7 | PASS | Yes | lightweight |  |
| 64 | Weisberg, Evan | Contains Nearby Duplicate | 8/8 | PASS | Yes | lightweight |  |
| 65 | Wong, Ethan | Contains Nearby Duplicate | 8/8 | PASS | Yes | lightweight |  |
| 66 | Wu, Xinlin | Merge Two Sorted Lists | 4/7 | Minor Error | Yes | lightweight | example1, interleave, all_same |
| 67 | Yang, Gabriel | Merge Two Sorted Lists | 1/7 | Critical Error | Yes | lightweight | example1, one_empty, other_empty, interleave, all_same, single_each |
| 68 | Yang, Isabella | Longest Substring Without Repeating Characters | 8/8 | PASS | Yes | lightweight |  |
| 69 | Yang, Kevin | Guess Number Higher or Lower | 0/7 | Critical Error | Yes | aggressive | basic, single, pick_low, pick_high, large, mid_range, pick_is_n |
| 70 | Yu, Justin | Merge Two Sorted Lists | 0/7 | Critical Error | Yes | aggressive | example1, both_empty, one_empty, other_empty, interleave, all_same, single_each |
| 71 | Yuan, Lilian | Guess Number Higher or Lower | 0/7 | Critical Error | Yes | aggressive | basic, single, pick_low, pick_high, large, mid_range, pick_is_n |
| 72 | Zaidi, Rijaa | Guess Number Higher or Lower | 0/7 | Critical Error | Yes | aggressive | basic, single, pick_low, pick_high, large, mid_range, pick_is_n |
| 73 | Zhang, Jiarong | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | aggressive | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
| 74 | Zhang, Ryan | Longest Substring Without Repeating Characters | 7/8 | Minor Error | No - Nested loops instead of sliding window | lightweight | example1 |
...
| 76 | Zhou, Qianjun | Guess Number Higher or Lower | 7/7 | PASS | Yes | lightweight |  |
| 77 | Zou, Elaine | Contains Nearby Duplicate | 8/8 | PASS | Yes | lightweight |  |
| 78 | Zuluaga, Santiago | Guess Number Higher or Lower | 7/7 | PASS | Yes | lightweight |  |
| 79 | Zuniga, Christian | Longest Substring Without Repeating Characters | 1/8 | Critical Error | Yes | aggressive | example1, all_same, example3, single_char, all_unique, spaces, end_longest |
...
- **Severity: Critical Error**
- **Score:** 2/7
- **Repair level:** java-transpile

| Test | Expected | Actual | Result |
|------|----------|--------|--------|
| basic | 6 | ERROR: TimeoutError: exceeded 5s | FAIL |
| single | 1 | ERROR: TimeoutError: exceeded 5s | FAIL |
| pick_low | 1 | 1 | PASS |
| pick_high | 2 | ERROR: TimeoutError: exceeded 5s | FAIL |
| large | 73 | ERROR: TimeoutError: exceeded 5s | FAIL |
| mid_range | 25 | 25 | PASS |
| pick_is_n | 20 | ERROR: TimeoutError: exceeded 5s | FAIL |
...
<details>
<summary>Student Code (68745.java)</summary>
...
<details>
<summary>Student Code (70003.py)</summary>
...
| one_empty | [0] | [0] | PASS |
| other_empty | [1] | [1] | PASS |
| interleave | [1, 2, 3, 4, 5, 6] | [1, 3, 5, 6] | FAIL |
| all_same | [1, 1, 1, 1] | ERROR: AttributeError: 'NoneType' object has no | FAIL |
| single_each | [1, 2] | [1, 2] | PASS |

<details>
<summary>Student Code (69542.py)</summary>
...
<details>
<summary>Student Code (66867.py)</summary>
