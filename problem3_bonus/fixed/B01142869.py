...
#                 return xor
# 
#                 This problem gave me an explicit set of instructions, telling me "For each query, you must apply the following operations in order:
# 
#                     Set idx = li.
#                     While idx <= ri:
