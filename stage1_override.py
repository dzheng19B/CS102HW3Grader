...
ROOT = r"C:\Users\danz3\Downloads\CS102HW3Grader"
CSV_PATH = os.path.join(ROOT, "submissions.csv")
...
def main():
    ...
    mm_path = os.path.join(ROOT, "missing_mandatory.csv")
    out = []
    ...
    # Document exception
    notes_path = os.path.join(ROOT, "overrides.md")
