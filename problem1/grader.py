"""
Stage 3 grader — Problem 1: max_valid_window_sum
Accepts both Python name (max_valid_window_sum) and Java-transpile name (maxValidWindowSum).
"""
...
FUNC_NAMES  = ["max_valid_window_sum", "maxValidWindowSum"]
